...
if int(row) in [2088,2126,2218,3079,3841,4330,4680]:
    fnd = np.genfromtxt('%s_%s/DirModel_width_data_dirichletborders_K10_cut' % (row,col))
else: 
    fnd = np.genfromtxt('%s_%s/DirModel_width_data_dirichletborders_K10' % (row,col))
